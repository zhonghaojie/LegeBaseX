...
public final class ResourceUtils {
    ...
    public static Drawable getDrawable(@DrawableRes int id) {
        return ContextCompat.getDrawable(BaseApp.getAppContext(), id);
    }
    ...
    public static int getIdByName(String name) {
        return BaseApp.getAppContext().getResources().getIdentifier(name, "id", BaseApp.getAppContext().getPackageName());
    }
    ...
    public static int getStringIdByName(String name) {
        return BaseApp.getAppContext().getResources().getIdentifier(name, "string", BaseApp.getAppContext().getPackageName());
    }
    ...
    public static int getColorIdByName(String name) {
        return BaseApp.getAppContext().getResources().getIdentifier(name, "color", BaseApp.getAppContext().getPackageName());
    }
    ...
    public static int getDimenIdByName(String name) {
        return BaseApp.getAppContext().getResources().getIdentifier(name, "dimen", BaseApp.getAppContext().getPackageName());
    }
    ...
    public static int getDrawableIdByName(String name) {
        return BaseApp.getAppContext().getResources().getIdentifier(name, "drawable", BaseApp.getAppContext().getPackageName());
    }
    ...
    public static int getMipmapIdByName(String name) {
        return BaseApp.getAppContext().getResources().getIdentifier(name, "mipmap", BaseApp.getAppContext().getPackageName());
    }
    ...
    public static int getLayoutIdByName(String name) {
        return BaseApp.getAppContext().getResources().getIdentifier(name, "layout", BaseApp.getAppContext().getPackageName());
    }
    ...
    public static int getStyleIdByName(String name) {
        return BaseApp.getAppContext().getResources().getIdentifier(name, "style", BaseApp.getAppContext().getPackageName());
    }
    ...
    public static int getAnimIdByName(String name) {
        return BaseApp.getAppContext().getResources().getIdentifier(name, "anim", BaseApp.getAppContext().getPackageName());
    }
    ...
    public static int getMenuIdByName(String name) {
        return BaseApp.getAppContext().getResources().getIdentifier(name, "menu", BaseApp.getAppContext().getPackageName());
    }
    ...
    public static boolean copyFileFromAssets(final String assetsFilePath, final String destFilePath) {
        boolean res = true;
        try {
            String[] assets = BaseApp.getAppContext().getAssets().list(assetsFilePath);
            if (assets != null && assets.length > 0) {
                ...
                res = FileIOUtils.writeFileFromIS(
                        destFilePath,
                        BaseApp.getAppContext().getAssets().open(assetsFilePath)
                );
            }
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public static String readAssets2String(final String assetsFilePath, final String charsetName) {
        try {
            InputStream is = BaseApp.getAppContext().getAssets().open(assetsFilePath);
    ...
    public static List<String> readAssets2List(final String assetsPath,
        ...
        try {
            return ConvertUtils.inputStream2Lines(BaseApp.getAppContext().getResources().getAssets().open(assetsPath), charsetName);
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public static boolean copyFileFromRaw(@RawRes final int resId, final String destFilePath) {
        return FileIOUtils.writeFileFromIS(
                destFilePath,
                BaseApp.getAppContext().getResources().openRawResource(resId)
        );
    }
    ...
    public static List<String> readRaw2List(@RawRes final int resId,
                                            final String charsetName) {
        return ConvertUtils.inputStream2Lines(BaseApp.getAppContext().getResources().openRawResource(resId), charsetName);
    }
}
